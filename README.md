...
本版本二次开发增加的功能是内置了STUN穿透功能，可以自动帮助您成为eD2k网络中的高ID，极大提升文件传输效率！
默认关闭STUN穿透功能，如需开启STUN功能，请在工具栏->选项(Options)->STUN/NAT穿透中开启
## 原Mod更新日志 (change log)
...
[IPV6功能因个人能力原因，没有对原mod版本进行任何扩展和修改，原mod仅支持手动输入来源来进行V6的传输(似乎还支持过通过交换服务器交换地址)，对于IPV6的支持度，需要询问原 Iron Mule 的mod开发者]

## 🚀 二开新功能：内置STUN穿透获取高ID(支持UDP穿透)
...
1.  **运营商网络支持**：你的宽带运营商必须支持“全锥型NAT (Full Cone NAT,NAT1) ”网络环境。（你可以联系运营商客服确认或先使用NAT类型检测网站后工具进行检测，确保是全锥型NAT (Full Cone NAT,NAT1) 网络环境。）
