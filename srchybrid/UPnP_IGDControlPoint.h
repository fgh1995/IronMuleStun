...
public:
	...
	*/
	...
	CUPnP_IGDControlPoint::UPNPNAT_RETURN AddPortMappingEx(WORD internalPort, WORD externalPort, UPNPNAT_PROTOCOL protocol, CString description);
	CUPnP_IGDControlPoint::UPNPNAT_RETURN AddPortMappingEx(CUPnP_IGDControlPoint::UPNPNAT_MAPPING * mapping);
...
private:
	...
	CUPnP_IGDControlPoint::UPNPNAT_RETURN AddPortMappingEx(WORD port, UPNPNAT_PROTOCOL protocol, CString description);
