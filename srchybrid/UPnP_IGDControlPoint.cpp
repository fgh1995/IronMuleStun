...
CUPnP_IGDControlPoint::UPNPNAT_RETURN CUPnP_IGDControlPoint::AddPortMappingEx(WORD internalPort, WORD externalPort, UPNPNAT_PROTOCOL protocol, CString description) {
	...
	return AddPortMappingEx(&mapping);
}

CUPnP_IGDControlPoint::UPNPNAT_RETURN CUPnP_IGDControlPoint::AddPortMappingEx(CUPnP_IGDControlPoint::UPNPNAT_MAPPING *mapping) {
	...
	if (!m_bInit) { // if not initialized then just note the mappings for later adding. 
